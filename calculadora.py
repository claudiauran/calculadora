...
pantalla.grid(row=0,column=1,padx=5,pady=5,rowspan=2,columnspan=4)#columnspan me permite que se ubiquen los numeros a lo ancho de la caja 
...
#-BOTONES EN PANTALLA:
#FILA 3
boton_bor=Button(miFrame,text="C",width=3,height=alto_boton,command=reset_pantalla)#lambda:nu(num="c",operacion="reset_pantalla"(nu.get)))
boton_bor.grid(row=3,column=1)
boton_Div=Button(miFrame,text="/",width=3,height=alto_boton,command=lambda:nu(num="/",operacion="divide"(nu.get())))
boton_Div.grid(row=3,column=2)
boton_Mult=Button(miFrame,text="x",width=3,height=alto_boton,command=lambda:nu(num="x",operacion="multiplica"(nu.get())))
...
boton_root=Button(miFrame,text="√",width=3,height=alto_boton,command=lambda:nu(num="√",operacion="sqrt"(nu.get)))
...
boton_porc=Button(miFrame,text="%",width=3,height=alto_boton,command=lambda:nu(num="%",operacion="porcentage"(nu.get())))
...
boton_bor=Button(miFrame,text="⌫",bg=color_boton,width=3,height=alto_boton,command=lambda:numeroPulsado("⌫",operacion="borrar_digito"(nu.get()))) 
boton_bor.grid(row=7,column=4)
boton_exp=Button(miFrame,text="exp",width=3,height=alto_boton,command=lambda:nu(num="**",operacion="potencia"(nu.get)))      #nu(num="**",operacion="potencia"(nu.get())))#numeroPulsado("**"))
...
boton_resultado=Button(miFrame,text="=",bg=color_boton,width=10,height=alto_boton,command=lambda:nu(num="=",operacion="resultado"(nu.get())))   #lambda:numeroPulsado("=",operacion="total_resultado"(nu.get)))
...
barraHorizontal=Scrollbar(miFrame,relief="raised",bg=color_boton, width=25,orient="horizontal",command=pantalla.xview)
